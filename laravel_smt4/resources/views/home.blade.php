...
<body>
    ...
    <!-- MAIN CONTENT -->
    <div class="container">
        <img src="{{ asset('images/logo_pink.jpeg') }}" alt="Logo Hidaya" class="logo-main">
        <h1>Selamat Datang di Website Pribadi Hidaya 🌷</h1>
        <p>Website pribadi yang feminin, sederhana, dan elegan 💖</p>

        <div class="id-card">
            <h3>ID CARD 💖</h3>
            <p><strong>Nama:</strong> Nur Hidayatus Sholekhah</p>
            <p><strong>NIM:</strong> G.211.23.0030</p>
